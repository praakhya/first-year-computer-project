...
class Play():
    ...
    def render(self):
        ...
        self.playB=Button(self.btnFrame,text='Play',command=self.choose,pady=5)
        self.ruleB=Button(self.btnFrame,text='Rules',highlightthickness=0.5,command=self.rules,pady=5)
        self.quitB=Button(self.btnFrame,text='Quit',highlightthickness=0.5,command=self.quit,pady=5)
